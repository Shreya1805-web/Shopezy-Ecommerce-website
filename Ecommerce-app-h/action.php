...
if(isset($_POST["getProduct"])){
	...
	$product_query = "SELECT * FROM products WHERE product_qty > 0 LIMIT $start,$limit";
...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			?>
				<a style="float:right;" href="cart.php" class="btn btn-warning">Show Cart`&nbsp;&nbsp;<span class="glyphicon glyphicon-edit"></span></a>
			<?php
			exit();
		}
	}
			...
			echo "<form method='post' action='login_form.php'>";
                ...
                <div class="col-md-2">
									<div class="btn-group">
										...
										<a href="#" update_id="'.$product_id.'" class="btn btn-primary">Update</a>
									</div>
								</div>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="http://localhost/ecommerce-app-h/payment_success.php" method="get">
